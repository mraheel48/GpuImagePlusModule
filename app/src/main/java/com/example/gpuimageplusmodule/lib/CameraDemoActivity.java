package com.example.gpuimageplusmodule.lib;
...
import com.example.gpuimageplusmodule.MainActivity;
import com.example.gpuimageplusmodule.R;
import com.example.gpuimageplusmodule.Utils;
...
//        lastVideoPathFileName = FileUtil.getPathInPackage(CameraDemoActivity.this, true) + "/lastVideoPath.txt";
        ...
        for (int i = 0; i != MainActivityNew.EFFECT_CONFIGS.length; ++i) {
            MyButtons button = new MyButtons(this, MainActivityNew.EFFECT_CONFIGS[i]);
